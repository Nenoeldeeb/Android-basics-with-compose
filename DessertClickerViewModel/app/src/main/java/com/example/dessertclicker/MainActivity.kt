...
private fun DessertClickerApp(DessertViewModel: DessertViewModel = viewModel()
	...
	Scaffold(topBar = {
		...
		DessertClickerAppBar(onShareButtonClicked = {
			shareSoldDessertsInformation(intentContext = intentContext, dessertsSold = uiState.dessertsSold,
		...
		DessertClickerScreen(revenue = uiState.revenue, dessertsSold = uiState.dessertsSold,
		                     dessertImageId = uiState.currentDessertImageId,
		                     onDessertClicked = DessertViewModel::onDessertClick, modifier = Modifier.padding(contentPadding))
	}
}
...
private fun TransactionInfo(revenue: Int, dessertsSold: Int, modifier: Modifier = Modifier
	...
	Column(modifier = modifier) {
		...
		RevenueInfo(revenue = revenue, modifier = Modifier
			.fillMaxWidth()
			.padding(dimensionResource(R.dimen.padding_medium)))
	}
}
...
private fun RevenueInfo(revenue: Int, modifier: Modifier = Modifier) {
	Row(
		...
		Text(text = stringResource(R.string.total_revenue), style = MaterialTheme.typography.headlineMedium,
		     color = MaterialTheme.colorScheme.onSecondaryContainer)
		Text(text = "$${revenue}", textAlign = TextAlign.Right, style = MaterialTheme.typography.headlineMedium,
		     color = MaterialTheme.colorScheme.onSecondaryContainer)
	}
}
...
private fun DessertsSoldInfo(dessertsSold: Int, modifier: Modifier = Modifier) {
	Row(
		...
		Text(text = stringResource(R.string.dessert_sold), style = MaterialTheme.typography.titleLarge,
		     color = MaterialTheme.colorScheme.onSecondaryContainer)
		Text(text = dessertsSold.toString(), style = MaterialTheme.typography.titleLarge,
		     color = MaterialTheme.colorScheme.onSecondaryContainer)
	}
}
